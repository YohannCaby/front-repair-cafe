    ...
    <v-row>
      <v-col>
        <div class="d-flex flex-row-reverse">
          <v-btn prepend-icon="mdi-account-plus" @click="saveVisiteur()"
            >Enregistrer Visiteur <v-icon icon="mdi-arrow-right-bold"></v-icon
          ></v-btn>
        </div>
      </v-col>
      <v-col>
        <div :hidden="hideAdhesion">
          <div class="d-flex flex-row-reverse">
            <v-btn prepend-icon="mdi-account-plus" @click="saveAdhesion()"
              >Valider Adhesion<v-icon icon="mdi-arrow-right-bold"></v-icon
            ></v-btn>
          </div>
        </div>
      </v-col>
