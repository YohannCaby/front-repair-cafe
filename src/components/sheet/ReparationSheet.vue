<template>
  <v-sheet border="mb" elevation="12" rounded="lg" witdh="100%">
    <v-container>
      <v-row class="rounded-lg bg-orange-lighten-2">
        <v-col cols="8">
          <p class="mx-auto" text="text-left">
            ...
            <strong
              >{{ reparation.benevole.nom }}
              {{ reparation.benevole.prenom }}</strong
            >
          </p>
        </v-col>
      ...
      <v-row>
        <v-col>
          <p class="text-left">Durée:</p>
        </v-col>
        <v-spacer></v-spacer>
        <v-col> {{ reparation.duree }} min </v-col>
      </v-row>
      <v-row>
        <v-col>
      ...
      <v-row>
        <v-col class="ml-10">
          <p class="text-justify">{{ reparation.commentaire }}</p>
        </v-col>
      </v-row>
    </v-container>
  </v-sheet>
