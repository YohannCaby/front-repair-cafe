...
export const useContexteVisiteurStore = defineStore('ContexteVisiteur',{
    ...
    getter:{
        getCurrentVisiteur: (state) => {state.currentVisiteur},
        getCurrentObjet: (state) => {state.currentObjet},
        getHasVisiteurChanged: (state) => {state.hasVisiteurChanged},
    },
    actions:{
        ...
        $reset(){
            ...
            console.log("Reset ContextVisiteur. currentVisiteur: ",this.currentVisiteur," currentObjet: ",this.currentObjet, "hasVisiteurChanged :",this.hasVisiteurChanged)
        }
    }
})